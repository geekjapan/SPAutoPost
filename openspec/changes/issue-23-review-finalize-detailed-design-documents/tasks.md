...
- [x] 1.1 `design-docs-review` capability の delta spec を作成する
- [x] 1.2 `openspec validate issue-23-review-finalize-detailed-design-documents --strict` を通す
...
- [x] 2.4 SharePoint 未決事項の #2 集約、LLM provider 未決事項の #15 集約を中央マトリクスで明示する
...
- [x] 3.3 PR を作成する（Closes #23、M0、OpenSpec change ID、verification、spec delta、security notes、follow-up issues）
