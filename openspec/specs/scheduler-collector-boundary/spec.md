# scheduler-collector-boundary Specification

## Purpose
TBD - created by archiving change issue-21-add-scheduler-external-collector-boundary. Update Purpose after archive.
## Requirements
