# Source Collection Specification (OpenSpec)

## Purpose

source-collection spec の OpenSpec 正本。
アプリケーション仕様の正本は `docs/specs/source-collection.md` を参照。
本ファイルは OpenSpec change が管理する requirement delta の集積先。
