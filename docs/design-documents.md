...
| `docs/specs/architecture.md` | Accepted for MVP direction | #4, #6, #7, #9, #10, #21, #23 | Azure hosted core、Python CLI/Batch command、Azure Container Apps / Jobs、管理 UI/API 早期追加方針 |
...
追加で、M1 には Azure Container Apps / Jobs 用の deployment skeleton を含めるか検討します。
