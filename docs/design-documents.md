...
|---|---|---|---|---|
| `docs/specs/sharepoint-publishing.md` | Accepted for MVP publishing mode and M1 dedicated SharePoint publishing | M0 Accepted with routed open questions | #2, #9, #20, #36 | Site Page / News を MVP 投稿方式として採用済み。board contract、Graph 権限、publish / promote、添付・画像、公開範囲の未決事項は #2 に集約する。 |
