...
| `docs/specs/review-approval-workflow.md` | Proposed | #19, #20, #26, #29, #31 | 人間レビュー、承認、差し戻し、公開制御 |
...
M1 では、PostgreSQL storage、TypeScript / Node.js Admin UI/API、Entra ID login、Azure Container Apps / Jobs deployment skeleton を含めます。
